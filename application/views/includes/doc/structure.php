<?php $this->load->view('includes/main-banner'); ?>

<section class="section-do">
	<div class="row-do row-mr">
		<div class="conent-do-3">
			...
			<?php $this->load->view('includes/doc/components/basic-inputs')?>
			<?php $this->load->view('includes/doc/components/input-sizes')?>
		</div>
		<?php $this->load->view('includes/right-menu')?>
